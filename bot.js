...
client.on('message', message => {
	...
	if (message.content.toLowerCase().substring(0, 11) == 'gnomo, deci') {
		...
		if (message.member.roles.find("name", "trastornada") ||message.member.roles.find("name", "sufrimiento") ||message.member.roles.find("name", "Celeste") ||message.member.roles.find("name", "Stop!") || message.member.roles.find("name", "stop") || message.member.roles.find("name", "Captain Obvious")){
